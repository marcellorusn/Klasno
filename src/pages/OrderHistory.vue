  ...
  <div>
    ...
    <div v-if="orders.length > 0" class="space-y-4">
      <div v-for="order in orders" :key="order.id" class="bg-white p-6 rounded-lg shadow-md">
        ...
        <Button @click="viewOrder(order.id)" variant="secondary">
          Vezi Detalii
        </Button>
      </div>
    </div>
...
const orders = ref([
  { id: 1001, date: '01 Septembrie 2024', total: 3500, status: 'Livrat', items: ['Laptop Dell XPS', 'Monitor LG'] },
  { id: 1002, date: '15 Septembrie 2024', total: 450, status: 'În Livrare', items: ['Tastatura Mecanică'] },
  { id: 1003, date: '20 Septembrie 2024', total: 199, status: 'În Pregătire', items: ['Cărți JavaScript'] }
])
